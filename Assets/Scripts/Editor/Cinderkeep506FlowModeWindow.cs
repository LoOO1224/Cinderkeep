...
{
    // 5.06 이후 일반/테스트초고속 모드의 낮밤 시간을 빠르게 조정하는 에디터 창입니다.
    ...
    public sealed class Cinderkeep506FlowModeWindow : EditorWindow
    {
        ...
        {
            Cinderkeep506FlowModeWindow window = GetWindow<Cinderkeep506FlowModeWindow>("5.06 Flow Mode");
        ...
        public static void ResetDefaultSettings()
        {
            ...
            Debug.Log("Cinderkeep 5.06: flow mode time settings reset to defaults.");
        }
